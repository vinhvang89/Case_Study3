    ...
    <div class="d-flex">
        ...
        <div class="--content-center">
            ...
            <table class="--content-center-news">
                <tr>
                    <td class="thumbnail">
                        <img class="--content-center-news-thumbnail" src="img/phicong.jpg"/>
                    </td>
                    <td class="--content-center-news-title">
                        ...
                        <p>
                            ...
                            văn hóa, văn nghệ TDTT trong Trại giam giai đoạn 2014 – 2018.Tham dự và chỉ đạo Hội nghị, có đồng chí
                            Đại tá Nguyễn Văn Lộc, Phó Cục trưởng Cục C10 – Bộ Công an.
                        </p>
                    </td>
                </tr>
                <tr>
                    <td class="thumbnail">
                        <img class="--content-center-news-thumbnail" src="img/tuankhi.jpg"/>
                    </td>
                    <td class="--content-center-news-title">
                        <h5>
                ...
                <tr>
                    <td class="thumbnail">
                        <img class="--content-center-news-thumbnail" src="img/matuy.png"/>
                    </td>
                    <td class="--content-center-news-title">
                        <h5>
